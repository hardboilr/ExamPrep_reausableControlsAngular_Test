...
app.factory('PersonFactory', function () {
    var persons = [
        ...
        {firstName: "Lars", lastName: "Fuckdig"},
        {firstName: "Bolle", lastName: "Severinsen"},
        {firstName: "Silas", lastName: "Gnom"},
        {firstName: "Gentleman", lastName: "Finn"},
        {firstName: "Kresten", lastName: "Pikhår"},
        {firstName: "Lærke", lastName: "Larsen"}];
